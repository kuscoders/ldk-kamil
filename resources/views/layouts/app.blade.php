        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @if(auth()->user()->can('genrate_surat.index') || auth()->user()->can('surat_keluar.index') || auth()->user()->can('surat_masuk.index'))
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2018 <div class="bullet"></div> LDK KAMIL-BG <div class="bullet"></div> All Rights
                    Reserved.
                </div>
