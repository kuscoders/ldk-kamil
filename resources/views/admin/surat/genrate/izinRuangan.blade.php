...
<body>
    ...
    <section class="section">
            <div class="section-header">
                <h3 align="center" style="padding: 20px;">Surat Izin Peminjaman Ruangan dan Peralatan kepada Kepala Akademik </h3>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.surat.genrate.izinRuangan_pdf') }}" method="post">
                    @csrf 
                    <div class="mb-3">
